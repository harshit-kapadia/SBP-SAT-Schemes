...
function [] = ex_moment2x3v_gaussian_collision(M)
%========================================================================
% Problem Parameters
%========================================================================
par = struct(...
    ...
    'ax',[0 0.5 0 1],... % extents of computational domain
...
par.system.B{2} = par.system.BIn * par.system.rotator{2};
par.system.B{3} = par.system.BWall * par.system.rotator{3};
par.system.B{4} = par.system.BIn * par.system.rotator{4};
