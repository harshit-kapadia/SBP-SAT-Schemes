...
function [] = ex_lid_driven_cavity(M)
%========================================================================
% Problem Parameters
%========================================================================
par = struct(...
    ...
    'n',[20 20],... % numbers of grid cells in each coordinate direction
...
par.output_filename = strcat('lid_driven_cavity/result_n',num2str(par.n(1)),'_M',num2str(M),'.txt');
...
filename_residual = strcat('lid_driven_cavity/residual_n',num2str(par.n(1)),'_M',num2str(M),'.txt');
