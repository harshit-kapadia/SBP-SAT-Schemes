...
#SBATCH --output=log_files_new/unsteady_lid_driven_cavity_n10_M13
...
matlab -singleCompThread -nodisplay -nodesktop -nosplash -logfile log_files_new/unsteady_lid_driven_cavity_n10_M13.txt <<EOF
run ex_unsteady_lid_driven_cavity(13);
quit();
EOF
