function [vect,value,pos_U] = compute_rhoW_prep_simple(Ax,Ay,all_weights)
...
for i = 1 : num_bc
    ...
    [vect{i},value{i},pos_U{i}] = compute_rhoW_at_wall(An,At,all_weights);
end
...
function [vect,value,pos_U] = compute_rhoW_at_wall(An,At,all_weights)
...
He_times_w_times_f0 = (He_2(neg_vn) + He_2(vt_neg_vn)).*w_times_f0/sqrt(2);% He_2(xi_1) + He_2(xi_2) * f0 * weights
value = dot(neg_vn,He_times_w_times_f0)/denominator;% integral of xi_n  * (He_2(xi_1) + He_2(xi_2) * f0)
